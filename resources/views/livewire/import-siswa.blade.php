        ...
        <div class="bg-white p-6 rounded-lg mt-3 shadow-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div class="col-span-1">
                    <div class="bg-gray-100 p-6 rounded-lg border border-gray-300">
                        ...
                        <form action="{{ route('import_siswa') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <button type="submit" class="w-full bg-blue-400 hover:bg-blue-600 text-white font-semibold py-3 rounded-lg shadow-md transition duration-300 flex items-center justify-center gap-2">
                ...
                <div class="col-span-1">
                    <div class="bg-gray-100 p-6 rounded-lg border border-gray-300">
                        ...
                        <a href="{{ asset('templates/siswa_template.xlsx') }}" class="mt-4 inline-block bg-green-500 text-white px-4 py-2 rounded-lg shadow hover:bg-green-600 transition">
            ...
            @if (session('import_result'))
                <div class="mt-6 p-4 bg-gray-100 border rounded-lg">
                    ...
                    <p class="text-green-700">Berhasil: <strong>{{ session('import_result')['success'] }}</strong></p>
                    <p class="text-red-700">Gagal: <strong>{{ session('import_result')['failed'] }}</strong></p>
                </div>
            @endif
                            ...
                            <tbody>
                                @foreach ($data_siswa as $index => $siswa)
                                    <tr class="border">
                                        ...
                                        <td class="py-2 px-4 border">{{ $siswa->kelas }}</td>
